...
def run_test_go_straight_for_seconds():
    ...
    # -------------------------------------------------------------------------
    robot = SimpleRoseBot()
    robot.go_straight_for_seconds(5, 75)
...
def run_test_go_straight_for_inches():
    ...
    # -------------------------------------------------------------------------
    robot = SimpleRoseBot()
    robot.go_straight_for_inches(5, 20)
...
def run_test_go_straight_until_black():
    ...
    # -------------------------------------------------------------------------
    robot = SimpleRoseBot()
    robot.go_straight_until_black(40)
...
class SimpleRoseBot(object):
    ...
    def go_straight_for_inches(self, inches, speed):
        pos = Motor.get_position(self.leftMotor)
        while inches <= pos:
            self.leftMotor.turn_on(speed)
            self.rightMotor.turn_on(speed)
        self.stop()
    ...
    def go_straight_until_black(self, speed):
        while self.colorSensor.get_reflected_light_intensity() != 0:
            self.leftMotor.turn_on(speed)
            self.rightMotor.turn_on(speed)
        self.leftMotor.turn_off()
        self.rightMotor.turn_off()
